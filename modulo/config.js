...
const ERROR_INTERNAL_SERVER = {status : false, status_code: 500, message: ' Não foi possivel processar a requisição devido a um problema na camada Controller do projeto. Contate o Administrador da API!!'}
